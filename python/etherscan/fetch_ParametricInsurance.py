...
# Contract address
CONTRACT_ADDRESS = '0xa4f3a8567e1d712fc8a53b3a1b6ec76dd42cc10b'
...
event_signatures = [
    "ParametersUpdated(uint16,uint16,uint16,uint16)",
    "Fund(address,uint256,uint256)",
    "Burn(address,uint256,uint256)",
    "InsuranceUnderwritten(uint256,address,bytes32,uint256,uint8)",
    "ClaimSettled(uint256,address,bool,uint256)"
]
